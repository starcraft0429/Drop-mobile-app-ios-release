              ...
              <View style={commonStyle.mdContent}>
                ...
                <View style={{}}>
                  <View style={styles.mdInput}>
                    <InputGroup style={styles.mdTextInput} >
                      <Icon name='ios-person-outline' style={{color:'#2196f3', fontSize: 27}}/>
                      <Input theme={myTheme} placeholder='Address label' />
                    </InputGroup>
                    <View style={{
                                  borderRadius: 3,
                                  borderWidth: 1,
